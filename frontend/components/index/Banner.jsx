...
import { initJarallax, initAOS } from "../../utils/theme";
    ...
    return (
        <>
            <section data-jarallax data-speed=".8"
                ...
                data-jarallax-video="mp4:/canal-loop.mp4">
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-12 col-md-10 col-lg-7 text-center">

                            <h1 className="display-2 font-weight-bold text-white" data-aos="fade-up" data-aos-delay="100">
                                <svg className="valorant-text" viewBox="0 0 690 98.9">
                            ...
                            <p className="lead mb-0 text-white-75" data-aos="fade-up" data-aos-delay="300">
                                Phân tích chia sẻ những điều liên quan đến valorant
                            </p>
